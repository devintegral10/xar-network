...
type Keeper struct {
	...
	// The reference to the bank to get information about balances
	bank BankKeeper
...
// BankKeeper expected bank keeper (balances storage) (noalias)
...
func NewKeeper(
	...
	supplyKeeper types.SupplyKeeper, bank BankKeeper, codespace sdk.CodespaceType, rtr types.Router,
) Keeper {
